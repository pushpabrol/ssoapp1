$(document).ready(function() {
    ...
    // instantiate Lock
    var lock = new Auth0Lock('3i65GNqgk9NENWIQ920WpLo7riwhADsU', 'pushp2.auth0.com');
    ...
    $('.btn-logout').click(function(e) {
      localStorage.removeItem('userToken');
      sessionStorage.removeItem('userToken');
      lock.logout({returnTo: location.search, client_id :'3i65GNqgk9NENWIQ920WpLo7riwhADsU'});
    });
